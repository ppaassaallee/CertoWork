...
| --- | --- | --- | --- |
| Odiseus (AI employee) | `/home`, Odiseus conversation | Enhanced | Tool loop, SSE work-log streaming, durable memory, skills invoke, schedules, approval-gated actions |
...
| Skills | `/work/skills`, Odiseus `run_skill` | Enhanced | Knowledge-backed skills remain available; Odiseus can invoke them as artifacts |
| Odiseus schedules | Automations panel | Enhanced | CRUD on `scheduled_tasks` with Run now into Odiseus chat |
