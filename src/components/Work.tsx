...
export function Work() {
  ...
  const sections = [
    ...
    { title: "Certo Work", count: "AI delivery operating layer", icon: Rocket, color: "text-lime-700", bg: "bg-lime-50", implemented: true, path: "/work/delivery-os" },
  ...
  return (
    ...
    >
      ...
      <div className="flex md:hidden gap-1 overflow-x-auto pb-3 -mx-4 px-4 scrollbar-none border-b border-b-gray-100">
        ...
        <button onClick={() => navigate("/work/delivery-os")} className="px-3 py-1.5 bg-gray-100 text-gray-600 rounded-full text-xs font-semibold whitespace-nowrap">Certo Work</button>
